...
const ListagemUsuarios = () => {
    ...
    const handleToggleStatus = async (id: number, statusAtual: boolean) => {
        try {
            ...
            const response = await fetch(`http://192.168.1.29:3000/usuarios/${id}/status`, {
                method: "PUT",
                headers: {
    ...
    const handleBuscarUsuarios = async () => {
        try {
            ...
            const response = await fetch(`http://192.168.1.29:3000/usuarios`, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${token}`,
    ...
    const salvarEdicao = async (id: number) => {
        ...
        try {
            const response = await fetch(`http://192.168.1.29:3000/atualizar/usuarios/${id}`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${token}`,
